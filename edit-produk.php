			...
			<div class="row my-4">
				...
				<form action="" method="POST" enctype="multipart/form-data">
				 <select class="input-control form-control" name="kategori" required>
					...
					<input type="text" name="nama" class="input-control form-control mt-2" placeholder="Nama Produk" value="<?php echo $p-> product_name ?>" required>
					<input type="text" name="harga" class="input-control form-control mt-2" placeholder="Harga" value="<?php echo $p-> product_price ?>" required>
					
					<img class="mt-2" src="produk/<?php echo $p->product_image ?>" width="100px">
					<input type="hidden" name="foto"  value="<?php echo $p->product_image ?>">
					<input type="file" name="gambar" class="input-control form-control mt-2">
					<br>
					<textarea class="input-control form-control" name="deskripsi" placeholder="Deskripsi"><?php echo $p->product_description?>" </textarea><br>
