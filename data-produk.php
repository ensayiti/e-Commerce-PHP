                ...
                <div class="row my-4">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a class="btn btn-warning" href="edit-produk.php?id=<?php echo $row['product_id'] ?>">Edit</a> <a class="btn btn-danger" href="proses-hapus.php?idp=<?php echo $row['product_id'] ?>" onclick="return confirm('Yakin ingin hapus ?')">Hapus</a>
							</td>
						</tr>
						<?php }}else{ ?>
							<tr>
