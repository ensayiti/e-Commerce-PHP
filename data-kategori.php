	...
	<div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                ...
                <div class="row my-4">
                    <div class="">
					<p><a href="tambah-kategori.php" class="btn btn-success">Tambah Data</a></p>
				<table border="1" cellspacing="0" class="table table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a class="btn btn-warning" href="edit-kategori.php?id=<?php echo $row['category_id'] ?>">Edit</a> <a class="btn btn-danger" href="proses-hapus.php?idk=<?php echo $row['category_id'] ?>" onclick="return confirm('Yakin ingin hapus ?')">Hapus</a>
							</td>
						</tr>
						<?php }}else{ ?>
							<tr>
